...
export const FormPicker = ({ id, errors }: FormPickerProps) => {
  ...
  const [images, setImages] =
    useState<Array<Record<string, any>>>(defaultImages); //* <Array<Record<string, any>>> ==> This means, It is an array of objects where each object has string keys and values could be any!
